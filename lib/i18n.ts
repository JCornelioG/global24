...
const es = {
  ...
  home: {
    ...
    newsletterAlready: "Ese correo ya estaba suscrito. ¡Gracias!",
    newsletterError: "No pudimos completar la suscripción. Inténtalo de nuevo en unos minutos.",
...
const en: typeof es = {
  ...
  home: {
    ...
    newsletterAlready: "That email was already subscribed. Thanks!",
    newsletterError: "We couldn't complete your subscription. Please try again in a few minutes.",
